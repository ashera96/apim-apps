...
const MCPServerMenu = (props) => {
    ...
    return (
        <Component
            ...
            title={(
                <FormattedMessage
                    id='Apis.Listing.MCP.mcp.server'
        ...
        >
            <LandingMenuItem
                dense={dense}
                id='itest-id-landing-create-mcp-server'
                linkTo='/apis/create/mcp-server'
                helperText={(
                    <FormattedMessage
                        id='Apis.Listing.SampleAPI.SampleAPI.mcp.server.import.content'
                        defaultMessage='Create MCP Servers by importing API contract'
                    />
                )}
            >
                <FormattedMessage
                    id='Apis.Listing.SampleAPI.SampleAPI.mcp.server.create.title'
